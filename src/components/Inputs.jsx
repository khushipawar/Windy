...
function Inputs({setQuery,units,setUnits}) {
  ...
  const handleLocationClick = () =>{
    ...
    {
      toast.info("Fetching users location."); navigator.geolocation.getCurrentPosition((position) =>
      {
...
<UilLocationPoint size={25} className="text-white cursor-pointer hover:scale-125" onClick = {handleLocationClick}/>
        </div>
